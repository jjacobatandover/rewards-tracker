        ...
        <div className="p-5">
          <div className="flex items-start justify-between gap-4">
            ...
            <button
              ...
              className="flex-shrink-0 text-xs px-3 py-1.5 rounded-md bg-red-900/20 border border-red-800/30 text-red-400 hover:bg-red-900/30 transition-colors"
            >
              Remove
            </button>
          </div>
        ...
        {([
          ...
          <button
            ...
            className={`text-xs px-3 py-1 rounded-md transition-colors flex items-center gap-1.5 ${
              filter === key ? 'bg-[#2a2a2a] text-white' : 'text-gray-500 hover:text-gray-300'
            }`}
          >
            {label}
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-5">
        {card.benefits.length === 0 ? (
          <div className="text-center py-10 text-gray-500 text-sm">
            <p>No benefits loaded for this card.</p>
          </div>
        ) : (
          categoryOrder
